package com.example.myscreensapp.ui.theme.Intents
...
fun IntentsScreen(navController: NavHostController){
    Column(
        ...
        Button(onClick = {
            val uri = Uri.parse("smsto:0727935913")
        ...
        Button(onClick = {
            val emailIntent = Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "fabricekinuthia3@gmail.com", null))
        ...
        Button(onClick = {
            val intent = Intent(Intent.ACTION_CALL, Uri.parse("tel:" + "0727935913"))
